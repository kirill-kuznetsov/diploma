...
${TESTDIR}/tests/newsimpletest.o: tests/newsimpletest.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newsimpletest.o tests/newsimpletest.c


${TESTDIR}/tests/newsimpletest4.o: tests/newsimpletest4.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newsimpletest4.o tests/newsimpletest4.c


${TESTDIR}/tests/newsimpletest3.o: tests/newsimpletest3.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newsimpletest3.o tests/newsimpletest3.c
